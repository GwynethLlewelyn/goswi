{{ define "footer.tpl" }}
  ...
  <!-- Page level plugins -->
  <script src="../lib/startbootstrap-sb-admin-2/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="../lib/startbootstrap-sb-admin-2/js/demo/chart-area-demo.js"></script>
  <script src="../lib/startbootstrap-sb-admin-2/js/demo/chart-pie-demo.js"></script>
