...
Some code was _inspired_ on [OpenSim Web Interface Redux](https://github.com/BigManzai/opensimwiredux) as well as the connection to the Remote Admin XML-RPC as provided by [Marcel Edward](https://github.com/MarcelEdward/OpenSim-RemoteAdmin). OpenSimWIRedux is currently going through a code rewrite

The grid map also requires mentioning its own licensing. I'll try to do it ASAP
