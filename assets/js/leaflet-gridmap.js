...
const ATTRIBUTION_LINE = 'Map data © 2021–2025 by Beta Technologies'
  ...
  for (var i = 0; i < __items.length; i++) {
    if (__items[i].nodeType === 1) {
      ...
      if (xmllocX == x && xmllocY == y) {
        ...
        response += '<td><a class="add" href="secondlife://http|!!' + GRID_URL + GRID_PORT + '/+' + xmlregionname + '">V3 HG</a>&nbsp;&nbsp;</td>'
